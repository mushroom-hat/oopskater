/* Copyright 2014 Singaporetech SIT
...
package com.singaporetech.notepad.old.activity;
...
import com.singaporetech.notepad.android.NotepadActivity;
import com.singaporetech.notepad.old.fragment.NoteEditFragment;
import com.singaporetech.notepad.old.fragment.NoteListFragment;
import com.singaporetech.notepad.old.fragment.NoteViewFragment;
import com.singaporetech.notepad.old.fragment.WelcomeFragment;
import com.singaporetech.notepad.old.fragment.dialog.BackButtonDialogFragment;
import com.singaporetech.notepad.old.fragment.dialog.DeleteDialogFragment;
import com.singaporetech.notepad.old.fragment.dialog.FirstRunDialogFragment;
import com.singaporetech.notepad.old.fragment.dialog.SaveButtonDialogFragment;
import com.singaporetech.notepad.old.util.WebViewInitState;
...
NoteViewFragment.Listener {
    ...
    private void reallyDeleteNotes() {
        ...
        deleteIntent.setAction("com.singaporetech.notepad.old.DELETE_NOTES");
        deleteIntent.putExtra("files", filesToDelete2);
        LocalBroadcastManager.getInstance(this).sendBroadcast(deleteIntent);

        Intent listIntent = new Intent();
        listIntent.setAction("com.singaporetech.notepad.old.LIST_NOTES");
    ...
    // Loads note from /data/data/com.singaporetech.notepad.old/files
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        ...
        if(resultCode == RESULT_OK && resultData != null) {
            ...
            if(requestCode == IMPORT) {
                ...
                listNotesIntent.setAction("com.singaporetech.notepad.old.LIST_NOTES");
