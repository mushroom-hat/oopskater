...
path = os.getcwd()
sys.path.insert(0, path + '\\diffviewer')
...
class MainWindow:
    ...
    def diff_files_into_text_areas(self):
        ...
        diff = difference.Difference(leftFileContents.splitlines(), rightFileContents.splitlines())
        ...
        for line in diff:
            ...
            if line['code'] == difference.Code.LEFT_SIDE:
